...
__CHEETAH_genTime__ = 1280511788.834626
__CHEETAH_genTimestamp__ = 'Fri Jul 30 12:43:08 2010'
__CHEETAH_src__ = 'dothtml_tmpl.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul 30 12:43:01 2010'
...
''')
                if len(VFFSL(SL,"o_html_list",True))>1: # generated from line 73, col 5
                    write('''  \t\t,
''')
                    for o_html in VFFSL(SL,"o_html_list",True)[1:-1]: # generated from line 75, col 5
                        write('''  \t\t\t''')
                        _v = VFFSL(SL,"o_html",True) # '$o_html' on line 76, col 6
                        if _v is not None: write(_filter(_v, rawExpr='$o_html')) # from line 76, col 6.
                        write(''', 
''')
                    write('''  \t\t''')
                    _v = VFFSL(SL,"o_html_list",True)[-1] # '$o_html_list[-1]' on line 78, col 5
                    if _v is not None: write(_filter(_v, rawExpr='$o_html_list[-1]')) # from line 78, col 5.
                    write('''
''')
                write('''  \t\t</li>
  \t\t
