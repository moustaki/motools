...
class MbzMetadataLookup :
	'''
		Lookup track based on input metadata
		MbzTrackLookup("path/to/file")
	'''

	def __init__(self,artist=None,album=None,title=None,threshold=60,duration_distance_threshold=10000) :
		'''
...
class MbzFileLookup :
	'''
		Lookup track based on input file
		MbzTrackLookup("path/to/file")
	'''

	def __init__(self,file,metadata=None,threshold=60,duration_distance_threshold=10000) :
		'''
		@param file: path to audio file with id3 tag
		@param metadata: don't use this, use MbzMetadataLookup()
		@param threshold=60 - the matching threshold, lower this to be more flexible
		@param duration_distance_threshold=10000
		'''
		self.file = file
		self.threshold = threshold
		self.ddt=duration_distance_threshold
