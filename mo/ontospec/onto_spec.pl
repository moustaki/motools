...
onto_spec(Spec) :-
	...
	setof(NC-Desc,(class_html_desc(_:NC,Desc)),DescsMess),
	keysort(DescsMess,Descs),
	reverse(Descs,DescsR),
	list_to_atom(DescsR,Classes),
	setof(NP-Descp,prop_html_desc(_:NP,Descp),DescspMess),
	keysort(DescspMess,Descsp),
	reverse(Descsp,DescspR),
	list_to_atom(DescspR,Properties),
	setof(NI-Desci,(ind_html_desc(_:NI,Desci)),DescsiMess),
